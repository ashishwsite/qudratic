...
//    const [descriment,setdescriment]=useState(0);
    ...
    return (
        <div className="container my-3"  style={{backgroundColor:'gray'}}>
        ...
        />
                ...
                <div className="mb-3">
                    <label htmlFor="b" className="form-label" style={{display:'block'}}>cofficent of X (b) </label>
        ...
        />
                ...
                <div className="mb-3">
                    <label htmlFor="c"  style={{display:'block'}} className="form-label">constant term (c) </label>
